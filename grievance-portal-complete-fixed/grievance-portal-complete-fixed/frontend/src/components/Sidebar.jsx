...
export default function Sidebar({ isOpen, onClose }) {
  return (
    <>
      ...
      <aside className="hidden lg:flex flex-col w-64 flex-shrink-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-r border-slate-200/80 dark:border-slate-800/80 h-full overflow-y-auto z-30">
